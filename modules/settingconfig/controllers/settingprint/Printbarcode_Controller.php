...
class Printbarcode_Controller extends MX_Controller
{
    ...
    public function FSxPriBarMoveDataIntoTable()
    {
        ...
        $aDataWhere = array(
            ...
            'tPrnBarBrowseBchFromCode' => $this->input->post('tPrnBarBrowseBchFromCode'),
            'tPrnBarBrowseBchToCode' => $this->input->post('tPrnBarBrowseBchToCode'),
            'tPrnBarBrowseGrpPriFromCode' => $this->input->post('tPrnBarBrowseGrpPriFromCode'),
     ...
     * Last Modified : 20/03/2023 Intouch(New) เพิ่มการส่ง Factor
     * Return : -
     * Return Type : -
     */
    function FSvPriBarMQProcess()
    {
        ...
        $aMQParams = [
            ...
            "params" => [
                ...
                'ptFilter'      => $this->session->userdata('tSesSessionID').date('YmdHis',strtotime($tDateNow)),
