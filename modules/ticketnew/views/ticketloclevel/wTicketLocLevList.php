		...
		<div class="row">
			<div class="col-lg-6 col-md-6 col-xs-12 col-sm-8">
				<div class="form-group">
					<label class="xCNLabelFrm"><?php echo language('ticketnew/ticketloclevel/ticketloclevel','tLEVSearch')?></label>
					<div class="input-group">
						<input type="text" class="form-control" id="oetSearchLev" name="oetSearchLev" placeholder="<?php echo language('ticketnew/ticketloclevel/ticketloclevel','tLEVSearchData')?>">
						<span class="input-group-btn">
							<button id="oimSearchLev" class="btn xCNBtnSearch" type="button">
						...
						<div id="odvMngTableList" class="btn-group xCNDropDrownGroup">
							...
							<ul class="dropdown-menu" role="menu">
								<li id="oliBtnDeleteAll" class="disabled">
									<a data-toggle="modal" data-target="#odvModalDelLev"><?php echo language('common/main/main','tDelAll')?></a>
								</li>
							</ul>
						</div>
					</div>
...
<div class="modal fade" id="odvModalDelLev">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<!-- แก้ -->
				<button id="osmConfirm" onClick="JSoLevDelChoose()" class="btn xCNBTNPrimery xCNBTNPrimery2Btn" type="button">
...
<script>
	$('#oimSearchLev').click(function(){
		JCNxOpenLoading();
		JSvLevDataTable();
	});
	$('#oetSearchLev').keypress(function(event){
		if(event.keyCode == 13){
			JCNxOpenLoading();
			JSvLevDataTable();
		}
