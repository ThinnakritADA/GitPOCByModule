...
class mProduct extends CI_Model
{
    ...
    public function FSaMPdtDeleteAll($paDataDel)
    {
        ...
        try {
            ...
            // -------- Delete data aboute product package -------- //
            
            // Create By Papitchaya 18/05/2023
            // TTKMPdtPkgGrp
            $this->db->where_in('FTPdtCode', $paDataDel['FTPdtCode']);
    ...
    // Last Update : Intouch(NEW) 01/03/2023 เปิดใช้งาน อัพเดทรหัสหน่วยให้อัพเดต barcode
