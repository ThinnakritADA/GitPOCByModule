...
function JSvCallPageProductEdit(ptPdtCode, tStatus) {
    ...
    function JSxPdtTypeControlTap(){
        ...
        let nPdtForSystem = $('#ocmPdtForSystem').val();
        if(nPdtForSystem == '5'){
            setTimeout(() => {
    ...
    if (typeof(nStaSession) !== 'undefined' && nStaSession == 1) {
        ...
        $('#ofmAddEditProduct').validate({
            ...
            submitHandler: function(form) {
                ...
                // ถ้าเป็นสินค้าระบบตั๋ว ให้เอา Sale type ของระบบตั๋ว
                let tPdtSaleType = ($('#ocmPdtForSystem').val() == '3') ? $('#ocmPdtTCKSaleType').val() : $('#ocmPdtSaleType').val() ;

                // Product Information 1
                var aPdtDataInfo1 = {
                    'tPdtType': $('#ocmPdtType').val(),
                    'tPdtSaleType': tPdtSaleType, // Papitchaya 11/05/2023
